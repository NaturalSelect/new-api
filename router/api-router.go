...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		// Login-password re-verification route (used by channel key view)
		apiRouter.POST("/verify_password", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.VerifyPassword)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/clear_model_pricing", controller.ClearModelPricing)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/key", middleware.RootAuth(), middleware.CriticalRateLimit(), middleware.DisableCache(), middleware.PasswordVerificationRequired(), middleware.SecureVerificationRequired(), controller.GetChannelKey)
