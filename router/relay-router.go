...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.TokenWindowQuotaLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.TokenWindowQuotaLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.TokenWindowQuotaLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.TokenWindowQuotaLimit(), middleware.Distribute())
	{
