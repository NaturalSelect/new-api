...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenQuotaLimit5h, token.QuotaLimit5h)
	common.SetContextKey(c, constant.ContextKeyTokenQuotaLimit7d, token.QuotaLimit7d)
	if len(parts) > 1 {
